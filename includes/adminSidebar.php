<div class="sidebar position-fixed top-0 bottom-0 bg-white border-end">
    <div class="d-flex align-items-center p-3">
        <a href="#" class="sidebar-logo fs-6 text-uppercase fw-bold text-decoration-none text-indigo fs-4">
            Mang Johnny Catering
        </a>
    ...
    <ul class="sidebar-menu p-3 m-0 mb-0">
        ...
        <li class="sidebar-menu-item has-dropdown">
            ...
            <ul class="sidebar-dropdown-menu">
                ...
                <li class="sidebar-dropdown-menu-item">
                    <a data-bs-target="#product_modal" data-bs-toggle="modal" href="#">
                        Add Product
                    </a>
                </li>
                <li class="sidebar-dropdown-menu-item">
        ...
        <li class="sidebar-menu-item has-dropdown">
            ...
            <ul class="sidebar-dropdown-menu">
                ...
                <li class="sidebar-dropdown-menu-item">
                    <a data-bs-target="#category_modal" data-bs-toggle="modal" href="#">
                        Add Category
                    </a>
                </li>
                <li class="sidebar-dropdown-menu-item">
